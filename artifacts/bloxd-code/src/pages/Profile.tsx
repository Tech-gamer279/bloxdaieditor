  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container px-4 py-8 max-w-2xl mx-auto space-y-6">
        ...
        <MediaUpload userId={user.id} title="Profile Media" description="Upload images and attachments to personalize your profile." uploadFolder="profile-media" />
        ...
        <div className="rounded-lg border border-border bg-card p-5 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input value={profile.username || ""} onChange={(e) => setProfile((p) => ({ ...p, username: e.target.value }))} placeholder="Your display name" maxLength={30} />
          </div>
          <div className="space-y-2">
            <label className="text-sm font-medium text-foreground">Bio</label>
            <Textarea value={profile.bio || ""} onChange={(e) => setProfile((p) => ({ ...p, bio: e.target.value }))} placeholder="Tell us about yourself..." maxLength={200} rows={3} />
